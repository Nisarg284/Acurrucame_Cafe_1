...
export default function LoginPage() {
    return (
        <main className="min-h-screen bg-[#020617] text-white selection:bg-amber-500/30 flex items-center justify-center relative overflow-hidden px-4">
            {/* Background Elements */}
            ...
            <div className="w-full max-w-md glass-panel p-8 rounded-2xl relative z-10 animate-fade-in-up">
                ...
                <div className="mt-8 text-center text-sm text-gray-400">
                    Don't have an account? <Link href="/signup" className="text-amber-500 hover:text-amber-400 font-bold">Sign up</Link>
                </div>
            </div>
        </main>
    );
